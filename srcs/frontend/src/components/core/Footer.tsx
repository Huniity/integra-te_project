export default function Footer() {
  ...
  return (
    <footer className="w-full mt-2 md:mt-3 flex justify-center relative z-20 shrink-0">
      <div className="bg-white/15 backdrop-blur-md rounded-3xl sm:rounded-full px-4 sm:px-6 md:px-8 py-1.5 sm:py-2.5 shadow-[0_8px_32px_rgba(31,38,135,0.18)] border border-white/40 ring-1 ring-white/20 flex flex-col md:flex-row items-center justify-between gap-4 w-full max-w-6xl mx-auto">
        <div className="flex flex-wrap items-center justify-center md:justify-start gap-2 sm:gap-4 md:gap-5">
          <div className="border-r border-white/30 pr-3 last:border-0">
