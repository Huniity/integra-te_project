            ...
            {LOGO_SRC ? (
              ...
              <>
                <button
                    onClick={() => navigate('/')}
                    className={`
                      flex items-center justify-center bg-center bg-no-repeat bg-[length:100%_100%]
                      hover:scale-105 transition-[transform,height,width] duration-200 ease-out cursor-pointer
                      ${isCompact ? 'h-14 w-[160px]' : 'h-22 w-[250px]'}
                    `}
                    ...
                    <img
                      ...
                      alt="INTEGRA-TE"
                      className={`
                        object-contain transition-[height,width,margin] duration-200 ease-out
                        ${isCompact ? 'h-14 w-[140px] mt-1' : 'h-24 w-[220px] mt-3'}
                      `}
                    />
                </button>
              </>
