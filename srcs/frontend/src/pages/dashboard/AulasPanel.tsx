...
function AulaModal({
    ...
    const [form, setForm] = useState<AulaPayload>(initial)
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
            <div className="w-full max-w-lg rounded-2xl bg-white shadow-2xl max-h-[90vh] overflow-y-auto">
                <div className="flex items-center justify-between border-b border-gray-100 px-6 py-4 sticky top-0 bg-white">
                    ...
                    <button onClick={onClose} className="rounded-full p-1 hover:bg-gray-100 cursor-pointer">
                        <X size={18} />
                    </button>
                </div>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-4 p-6">
                    ...
                    <div>
                        ...
                        />
                        {form.ficheiro && (
                            <p className="mt-1 text-xs text-gray-400">{(form.ficheiro as File).name}</p>
                        )}
                    </div>
                    ...
                    <div className="flex justify-end gap-2 pt-1">
                        <button
                            type="button"
                            onClick={onClose}
                            className="rounded-lg border border-gray-200 px-4 py-2 text-sm font-semibold hover:bg-gray-50 cursor-pointer"
                        >
                            Cancelar
                        </button>
                        <button
        ...
        <div className="flex-1 min-h-0 flex flex-col gap-3">
            ...
            <div className="flex-1 min-h-0 overflow-y-auto rounded-2xl border border-gray-200 bg-white shadow-sm">
                {isLoading ? (
                    ...
                    <div className="flex h-40 items-center justify-center text-gray-400 font-semibold">
                        ...
                        <tbody className="divide-y divide-gray-100">
                            {pageItems.map((aula) => (
                                <tr key={aula.id} className="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td className="px-4 py-3">
                                        <span className={`inline-block rounded-full px-2.5 py-0.5 text-xs font-bold ${aula.publicado ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-400'}`}>
                                            ...
                                            {deleteId === aula.id ? (
                                                ...
                                                <>
                                                    <button
                                                        ...
                                                        className="rounded p-1.5 text-gray-400 hover:bg-purple-50 hover:text-purple-600 cursor-pointer"
                                                        title="Visualizar"
                                                    >
                                                        <Eye size={15} />
                                                    </button>
                                                    <button
                                                        ...
                                                        className="rounded p-1.5 text-gray-400 hover:bg-blue-50 hover:text-blue-600 cursor-pointer"
                                                        title="Editar"
                                                    >
                                                        <Pencil size={15} />
                                                    </button>
